...
const TestimonialCard = () => {
  return (
    <>
      <div className="flex lg:hidden xl:flex flex-col sm:flex-row items-start gap-5 px-[25px] sm:px-[50px] py-[20px] sm:py-[40px]  testimonial-card">
        <div className="flex items-center justify-center h-20 w-20 sm:w-44 bg-slate-200 rounded-full">
          <img src={start} className=" rounded-full bg-slate-100" />
        </div>
        <div>
          <p className="text-[14px] md:text-[16px] font-[400] leading-[22px] md:leading-[24px] pb-5 border-b border-b-black">
          ...
          <div className="flex flex-col sm:flex-row items-start justify-between my-2 md:my-5">
            <div className="flex flex-col gap-2">
              <h5 className="text-[14px] md:text-[16px] font-[600] leading-[24px]">
                Asmar Tamjid
              </h5>{" "}
              <p className="text-purpleLight text-[14px] md:text-[16px] ">
                front end developer
              </p>
            </div>
        ...
        <div>
          ...
          <div className="flex items-start justify-between my-5">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-purpleLight">front end developer</p>
            </div>
            <div className="flex gap-2">
              <img src={start} />
              <img src={start} /> <img src={start} /> <img src={start} />
