...
import { blogDataThree } from "../constant/BlogsData";
...
const BlogsThree = ({ pagetitle, pageSubTitle }) => {
  return (
    <div className="max-w-[1200px] xl:max-w-[1400px]  mx-auto px-10 mt-16">
      <div className="  flex flex-col justify-center items-center">
        ...
        <p className="text-center text-body font-[500] text-[16px] leading-[24px] lg:max-w-[806px] mt-5">
          {pageSubTitle}
        </p>
        {/* ==================================== `card web view` ============================== */}
        <div className="hidden lg:grid grid-cols-2 xl:grid-cols-3 ">
          {blogDataThree.map((card, index) => (
