...
function TermsAndConditions() {
  ...
  return (
    <Layout>
      <Halmet
        title={"Terms & Conditions-SyncClouds"}
        description={
          "Understanding our partnership terms is essential. Explore SyncClouds Terms and Conditions for transparent collaboration."
        }
      />
      {inView ? (
